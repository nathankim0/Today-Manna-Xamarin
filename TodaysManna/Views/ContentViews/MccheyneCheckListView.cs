...
{
    public partial class MccheyneCheckListView : ContentView
    {
        private CollectionView _collectionView;
        private readonly OptionPopup _optionPopup;
        private MccheyneCheckContent _todayMccheyne;
        MccheyneCheckViewModel viewModel;
        public MccheyneCheckListView()
        {
            //BindingContext = App.mccheyneCheckViewModel;
            viewModel = BindingContext as MccheyneCheckViewModel;

            viewModel.Loaded = false;
            Initialize();
            viewModel.Loaded = true;

            _todayMccheyne = viewModel.MccheyneCheckList.Where(x => x.Date == DateTime.Now.ToString("M-d")).FirstOrDefault();
